            ...
            <?php } ?>
              ...
              <div class="box-body">
                ...
                <div class="form-group" style="display:inline-block;">
                  ...
                  <input type="text" name="kode_barang" readonly="readonly" style="width: 87%;margin-right: 10px;margin-left: 11px;" class="form-control" id="kode_barang" value="<?=$d->kode_barang?>">
                </div>
                <div class="form-group" style="display:inline-block;">
                  <label for="nama_Barang" style="width:73%;">Nama Barang</label>
                  <input type="text" name="nama_barang" readonly="readonly" style="width:80%;margin-right: 10px;" class="form-control" id="nama_Barang" value="<?=$d->nama_barang?>">
              </div>
                <div class="form-group" style="display:inline-block;">
                  <label for="satuan" style="width:73%;">Satuan</label>
                  <select class="form-control" name="satuan" style="width:110%;margin-right: 30px;">
              ...
              <div class="form-group" style="display:inline-block;">
                  <label for="penerima" style="width:90%; margin-left: 30px">Penerima</label>
                  <input type="text" class="form-control" name="penerima" style="width:90%; margin-left: 30px; margin-right: 10px;" id="penerima">
                    </div>
