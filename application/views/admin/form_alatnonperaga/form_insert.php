      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="<?php echo base_url('admin/form_alatnonperaga')?>"><i class="fa fa-circle-o"></i> Tambah Data Alat Non Peraga</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary" style="width:94%;">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-archive" aria-hidden="true"></i> Tambah Data Alat Non Peraga</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <div class="container">
            <form action="<?=base_url('admin/proses_alatnonperaga_masuk_insert')?>" role="form" method="post">
            ...
            <?php } ?>
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" name="id_transaksi" style="margin-left:37px;width:20%;display:inline;" class="form-control" readonly="readonly" value="ANP-<?=date("Y");?><?=random_string('numeric', 8);?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="jenis" style="margin-left:65px;width:20%;display:inline;">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="nama_alat" style="margin-left:35px;width:20%;display:inline;" class="form-control" id="nama_alat" placeholder="Nama Alat">
                </div>
                <div class="form-group">
                  <label for="satuan" style="margin-left:100px;display:inline;">Satuan</label>
                  <select type="text" name="satuan" style="margin-left:10px;margin-right:50px;width:20%;display:inline;" class="form-control" id="satuan">
                    <option value="">-- Pilih --</option>
                ...
                <div class="form-group" style="display:inline-block;">
                  <label for="letak" style="width:30%;">Letak</label>
                  <select type="text" name="letak" style="width:90%;margin-right: 50px;" class="form-control" id="letak">
                    <option value="">-- Pilih --</option>
                    <option value="Lab. Farmasetika">Lab. Farmasetika</option>
                    <option value="R. Peny. Alat">R. Peny. Alat</option>
                    </select> 
              </div>
            ...
            <div class="form-group" style="display:inline-block;">
              ...
              <div class="box-footer" style="width:93%;">
                ...
                <a type="button" class="btn btn-info" style="width:25%;margin-right:10%" href="<?=base_url('admin/tabel_alatnonperaga')?>" name="btn_listbarang"><i class="fa fa-table" aria-hidden="true"></i> Data Alat Non Peraga</a>
