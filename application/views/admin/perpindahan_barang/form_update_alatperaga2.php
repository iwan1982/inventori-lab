      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary" style="width:94%;">
            ...
            <!-- form start -->
            <div class="container">
            <form action="<?=base_url('admin/proses_data_alatperagakembali')?>" role="form" method="post">
            ...
            <?php } ?>
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="tanggal_masuk" style="margin-left:220px;display:inline;">Tanggal Masuk</label>
                  <input type="text" name="tanggal_masuk" style="margin-left:66px;width:20%;display:inline;" class="form-control" readonly="readonly" value="<?=$d->tanggal_masuk?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group" style="">
                  ...
                  <input type="text" name="merk" style="margin-left:125px;width:20%;display:inline;" class="form-control" id="merk" readonly="readonly" value="<?=$d->merk?>">
                </div>
                <div class="form-group" style="">
                ...
                <div class="form-group" style="display:inline-block;">
                  ...
                  <input type="text" name="pj" class="form-control" style="width:100%;margin-right: 20px;" id="pj" readonly="readonly" value="<?=$d->pj?>">
                    </div>
              <div class="form-group" style="display:inline-block;">
                  <label for="nim" style="width:90%; margin-left: 30px">NIM / Kelas</label>
                  <input type="text" class="form-control" name="nim" style="width:90%; margin-left: 30px; margin-right: 10px;" id="nim" readonly="readonly" value="<?=$d->nim?>">
                    </div>
                    <div class="form-group" style="display:inline-block;">
                  <label for="hp" style="width:90%; margin-left: 30px">No HP</label>
                  <input type="number" class="form-control" name="hp" style="width:90%; margin-left: 30px; margin-right: 10px;" id="hp" readonly="readonly" value="<?=$d->hp?>">
                    </div>
