      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="<?= base_url('admin/tabel_alatnonperagakembali')?>"><i class="fa fa-circle-o"></i> Tabel Alat Non Peraga Kembali</a>
            </ul>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li>Tables</li>
        <li class="active"><a href="<?=base_url('admin/tabel_alatnonperagakeluar')?>">Tabel Alat Non Peraga Keluar</a></li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"><i class="fa fa-table" aria-hidden="true"></i> Data Alat Peraga Kembali</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              ...
              <a href="<?=base_url('report/alatnonperagaKembali')?>" style="margin-bottom:10px;" type="button" class="btn btn-danger" name="laporan_data"><i class="fa fa-file-text" aria-hidden="true"></i> Recap Laporan </a>
