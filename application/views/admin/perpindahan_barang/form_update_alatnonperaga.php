      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary" style="width:94%;">
            ...
            <!-- form start -->
            <div class="container">
            <form action="<?=base_url('admin/proses_data_alatnonperagakeluar')?>" role="form" method="post">
            ...
            <?php } ?>
              ...
              <div class="box-body">
                ...
                <div class="form-group" style="display:inline-block;">
                  ...
                  <input type="text" name="pj" class="form-control" style="width:100%;margin-left: 20px;margin-right: 20px;" id="pj" placeholder="Nama Penangung Jawab">
                    </div>
              <div class="form-group" style="display:inline-block;">
