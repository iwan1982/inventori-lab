        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary" style="width:94%;">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-archive" aria-hidden="true"></i> Update Data Alat Non Peraga</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <div class="container">
            <form action="<?=base_url('admin/proses_alatnonperaga_masuk_update')?>" role="form" method="post">
            ...
            <?php } ?>
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="nama_alat" style="margin-left:35px;width:20%;display:inline;" class="form-control" id="nama_alat" value="<?=$d->nama_alat?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group" style="display:inline-block;">
                  ...
                  <select type="text" name="letak" style="width:90%;margin-right: 50px;" class="form-control" id="letak">
                    <option value="<?=$d->letak?>"><?=$d->letak?></option>
